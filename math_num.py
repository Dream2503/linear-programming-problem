...
str_equivalent: dict[Fraction, str] = {PI: "π", E: "e"}
FUNCTIONS: set[str] = {
    "abs", "sqrt", "cbrt", "log", "ln", "sin", "cos", "tan", "asin", "acos", "atan", "sinh", "cosh",
...
class MathNum:
    ...
    def __init__(
            self, num: Any = 0, *, operations: list[tuple[Callable, "MathNum | None"]] | None = None,
